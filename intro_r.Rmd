...
```{r echo=FALSE}
knitr::include_graphics("assets/appendix/gifs/appendix_checked.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("assets/appendix/gifs/appendix_install_bttn.gif")
```
